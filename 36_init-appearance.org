...
*** font size
    ...
    ;;(defvar dongil/efontsize  15)
    ;;(defvar dongil/hfontsize  15)
    ;;(defvar dongil/symbolsize 20)

    (setf dongil/efontsize  15)
    (setf dongil/hfontsize  15)
...
*** 심볼 폰트
    ...
    (let ((emojifont (find-if 
                        (lambda (x) (font-utils-exists-p x)) 
                        '("Noto Emoji" "NotoSymbol" "Segoe UI Symbol"    ))))
...
*** 한글 폰트
  ...
  (let ((hangulfont (find-if
                      (lambda (x) (font-utils-exists-p x))
                      '(  "Malgun Gothic" "D2Coding" "나눔고딕코딩" "돋움체" "Noto Sans CJK KR Regular"  ))))

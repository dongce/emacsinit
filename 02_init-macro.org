...
#+BEGIN_SRC emacs-lisp
  ...
  Argument TEXT alarm message."
    (let ((buf (get-buffer-create " *alarm notify* ")))
      ...
      (async-shell-command (format "c:\\anaconda43\\python.exe t:/usr/local/editor/emacsw32/cmdutils/pymsgdialog.py \"%s\"  " text) buf) 
    ...
    (defun captool(arg)
      ...
      (setf
       ...
       (cond
        ...
        ((equal 2 arg )
         "t:/usr/local/editor/emacsW32/iview_x64/i_view64.exe /capture=5 ")
        (t
         "t:/usr/local/editor/emacsW32/iview_x64/i_view64.exe /capture=4 /convert=%f"))))
  #+END_SRC

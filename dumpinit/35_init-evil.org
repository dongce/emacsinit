...
*** magit
    #+BEGIN_SRC emacs-lisp
      ...
      ;;     (general-def 'emacs magit-mode-map "j" 'magit-goto-next-section)
      ;;     (general-def 'emacs magit-mode-map "k" 'magit-goto-previous-section)
      ;;     (general-def 'emacs magit-mode-map "K" 'magit-discard-item))) 

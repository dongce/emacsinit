...
* external
  #+BEGIN_SRC emacs-lisp
;; (use-package :ensure calc-ext)
(use-package sqlite
     :demand
  :config
  (setq  sqlite-program "sqlite3"))
...
* secret
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package simple-secrets
      ...
      :init 
      (setq secret-password-file "/mnt/u/orgdir/secrets.gpg")
      :config
      (secret-load-keys))
  #+END_SRC
...
** origin
  #+BEGIN_SRC emacs-lisp
    ...
    ;;donouse;;(use-package smartscan
    ;;donouse;;  :ensure 
    ;;donouse;;  :config 
    ;;donouse;;  (global-smartscan-mode t)
    ;;donouse;;  (unbind-key "M-n" smartscan-map)
    ;;donouse;;  (unbind-key "M-p" smartscan-map)
    ;;donouse;;  )
...
* password file
  #+BEGIN_SRC emacs-lisp
  (setq espy-password-file "u:/orgdir/password.org.gpg")
  #+END_SRC

  #+RESULTS:
  : u:/orgdir/password.org.gpg
* SDCV dictionary

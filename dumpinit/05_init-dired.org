...
#+BEGIN_SRC emacs-lisp
  ...
  (defun w32-dired-open-explorer-tmp ()
    (interactive)
    (let* ((tname (dired-get-file-for-visit))
           (fname (file-name-nondirectory tname)))
      (dired-copy-file tname "/tmp/" nil)
      (w32open (concat "/tmp/" fname ))))
        ...
        (append 
         (mapcar
          ...
          `(
            ...
            (qdir        "t:/usr/local/qdir/Q-Dir_x64.exe")
...
#+BEGIN_SRC emacs-lisp
  (leaf  dired-x
    ...
    :hook ((dired-mode-hook . dired-omit-mode)
           ...
           (dired-mode-hook . display-line-numbers-mode))
    :config

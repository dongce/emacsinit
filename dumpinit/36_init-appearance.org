   ...
   #+begin_src emacs-lisp
     (leaf popwin
       ...
       (general-define-key
        ...
        (kbd "C-z C-z") #'keyboard-quit))
   #+end_src

   #+RESULTS:
   : (keymap (49 . popwin:one-window) (21 . popwin:universal-display) (101 . popwin:messages) (6 . popwin:find-file) (102 . popwin:find-file) (48 . popwin:close-popup-window) (115 . popwin:stick-popup-window) (32 . popwin:select-popup-window) (15 . popwin:original-display-last-buffer) (16 . popwin:original-pop-to-last-buffer) (2 . popwin:switch-to-last-buffer) (111 . popwin:display-buffer) (108 . popwin:popup-last-buffer) (98 . popwin:popup-buffer))
